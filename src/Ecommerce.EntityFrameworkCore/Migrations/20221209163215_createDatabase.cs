    ...
    public partial class createDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCategoríe", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductCategoríe_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_ProductCategoríe_ProductCategoryId",
                        column: x => x.ProductCategoryId,
                        principalTable: "ProductCategoríe",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductDocumentFiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductDocumentFiles_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DocumentFiles_ProductDocumentFiles_ProductDocumentFileId",
                        column: x => x.ProductDocumentFileId,
                        principalTable: "ProductDocumentFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentFiles_ProductDocumentFileId",
                table: "DocumentFiles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategoríe_CategoryId",
                table: "ProductCategoríe",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductDocumentFiles_ProductId",
                table: "ProductDocumentFiles",
                column: "ProductId");
