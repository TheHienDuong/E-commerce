...
public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        await CreateApiScopeAsync("Ecommerce");
    }
    ...
    private async Task CreateApiResourcesAsync()
    {
        ...
        await CreateApiResourceAsync("Ecommerce", commonApiUserClaims);
    }
    ...
    private async Task CreateClientsAsync()
    {
        ...
        {
            var webClientRootUrl = configurationSection["Ecommerce_App:RootUrl"]?.TrimEnd('/');
            ...
            await CreateClientAsync(
                ...
                secret: (configurationSection["Ecommerce_App:ClientSecret"] ?? "1q2w3e*").Sha256(),
        ...
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            ...
            await CreateClientAsync(
                ...
                secret: configurationSection["Ecommerce_Swagger:ClientSecret"]?.Sha256(),
                requireClientSecret: false,
